...
$string['error:identityexists'] = 'A skill with this key already exists. Please use a unique key.';
...
$string['invalidlevelforskill'] = 'The selected level does not belong to this skill';
$string['key'] = 'Key';
$string['learningtime'] = 'Learning time';
$string['learningtime_help'] = 'Time to spend in the course to complete this skill';
$string['leveldefaultname'] = 'Level {$a}';
$string['levelnotfound'] = 'Level not found';
...
$string['levelscount_help'] = 'Choose the total number of levels for this skill. Select "No levels" for a points-only skill with no level structure. Selecting 1 gives a single level. Each additional level requires more points to achieve.';
...
$string['skillcoursenotset'] = 'Course skill instance is not set';
$string['skillnotavailableincourse'] = 'This skill is not available for this course';
$string['skillnotfound'] = 'Skill not found';
...
$string['skillsactivated'] = 'Skill has been activated';
$string['skillsarchived'] = 'Skill has been archived';
